...
<form method="POST" action="../core/process_user.php">
    <h2>Register</h2>
    ...
    <button class="btn" name="createUser" type="submit">Register</button>
    <div class="register-link">
    <p>Don't have an account? <a href="loginPage.php">Create one here</a></p>
    </div>
</form>
        </div>
    </div>
